...
class Book(models.Model):
    ...
    cover = models.ImageField(upload_to="SejongApp/book/covers", verbose_name="Cover", storage=gd_storage, blank=True, null=True) 
    file = models.FileField(upload_to="SejongApp/book/files", storage=gd_storage)  
